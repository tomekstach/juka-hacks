...
<?php if ($this->item->state == 0 || (!empty($this->item->publish_up) && strtotime($this->item->publish_up) > strtotime(JFactory::getDate())
	|| (!empty($this->item->publish_down) && strtotime($this->item->publish_down) < strtotime(JFactory::getDate())) && $this->item->publish_down != JFactory::getDbo()->getNullDate())) : ?>
